...
public:
    ...
    void setupUi(QMainWindow *login)
    {
        ...
        labelServerIP->setGeometry(QRect(20, 110, 61, 20));
        ...
        labelServerPort->setGeometry(QRect(20, 150, 81, 20));
    ...
    void retranslateUi(QMainWindow *login)
    {
        ...
        labelServerIP->setText(QApplication::translate("login", "Server IP", 0));
